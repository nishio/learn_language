...
.. code-block:: python
  ...
  # æ—¥æœ¬èªã§ã‚³ãƒ¡ãƒ³ãƒˆã‚’æ›¸ã„ãŸã ã‘
...
Perlã§ã¯ã‚³ãƒ¡ãƒ³ãƒˆä¸­ã®\ãŒæ”¹è¡Œã‚’ã‚¨ã‚¹ã‚±ãƒ¼ãƒ—ã—ãªã„ã®ã§2ãŒã‚³ãƒ¡ãƒ³ãƒˆã‚¢ã‚¦ãƒˆã•ã‚Œãªã„
